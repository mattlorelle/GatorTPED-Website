...
export default function SimpleAccordion() {
  ...
  return (
      <div className={classes.div} style={{ position: 'fixed', left: '50%', top: '40%', transform: 'translate(-50%, -50%)'}}>
                ...
                <Grid container spacing={4}>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel3a-content" id="panel3a-header">
                                <HelpTwoToneIcon/>
                                <Typography className={classes.heading}>HOW DO I JOIN GATOR TPED?</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                                <HelpTwoToneIcon/>
                                <Typography className={classes.heading}>WHO CAN JOIN GATOR TPED?</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                                <HelpTwoToneIcon/>
                                <Typography className={classes.heading}>IS THIS CLUB JUST FOR ENGINEERS?</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                                <HelpTwoToneIcon/>
                                <Typography className={classes.heading}>WHAT IS THE DESIGN TEAM?</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                                <HelpTwoToneIcon/>
                                <Typography className={classes.heading}>HOW DO I JOIN THE DESIGN TEAM?</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                                <HelpTwoToneIcon/>
                                <Typography className={classes.heading}>DO I NEED EXPERIENCE TO JOIN THE DESIGN TEAM?</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                    ...
                    <Grid item xs={12}>
                        <Accordion>
                            <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                                <HelpTwoToneIcon/>
                                <Typography className={classes.heading}>WHAT IS SWAMP THRILLS?</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
